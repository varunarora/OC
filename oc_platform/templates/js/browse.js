require(['categoryResources'], function(categoryResources){
    var Category = categoryResources['Category'],
        Resource = categoryResources['Resource'],
        Request = categoryResources['Request'];
    ...
    {% for item in items %}
        ...
        OC.categoryResources.resourceSet.add(resource);
        {% else %}
        ...
        OC.categoryResources.resourceSet.add(collection);
        {% endif %}
    {% empty %}
    {% endfor %}
    {% endif %}
    ...
    {% if not query and query != '' and category_group %}
        ...
        OC.categoryResources.requestSet.add(newRequest);

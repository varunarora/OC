...
urlpatterns = patterns(
    ...
    # Discussions
    url(r'^topic/(?P<topic_id>.*)/$', 'discussions.views.topic', name='topic'),
    url(r'^board/(?P<board_id>.*)/$', 'discussions.views.board', name='board'),
    url(r'^discussions/', 'discussions.views.discussions', name='discussions'),
